...
<html>
    ...
    <body class="container">
        <div class="row">
            ...
            <div id="Barra de busqueda" class="col-md-3">
                <div>
                    <a href="http://localhost:8080/BibliotecaTest/Catalogo.jsp">Inicio</a>
                </div>
            </div>
        ...
        <div class="wrap">
            ...
            <form class="Buscador">
            <input type="text" placeholder="Introduce el nombre de un libro" name="search" size="25">
            <button type="submit" onclick = "BuscarLibro(search.value)"></button>
            </form>
            <br>
  ...
  <%
                   ...
                   String sql = "Select id,nombre,genero,autor from libros where nombre like '%mundo%'";
